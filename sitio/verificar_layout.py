...
================================================
Abre cada página publicada (`PAGINAS`) en los tres idiomas y en tres anchos
reales, y comprueba, con mediciones del navegador y no a ojo, que nada se
pisa.
...
# Todas las páginas que genera sitio/build.py. Si se agrega una página nueva
